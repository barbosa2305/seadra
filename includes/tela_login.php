...
$frm = new TForm('Acesso ao Sistema',120,400);
$frm->hideCloseButton();
$frm->addTextField('login'		,'Usuário:',20,true,20);
...
if( $acao =='login'){
    ...
    $msg = Usuario::login($nom_user,$pwd_user);
    if( $msg == 1 ) {
        ...
        $frm->setMessage('Usuário Inválido!');
        prepareReturnAjax(0);
    }
}
