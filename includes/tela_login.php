...
$frm = new TForm('Acesso ao Sistema',110,400);
$frm->setFlat(true);
$frm->hideCloseButton();
$frm->setColumns('50');

$frm->addTextField('login','Usuário',20,true,35)->setAttribute('align','center');
$frm->addPasswordField('senha','Senha',true,null,20,null,null,null,35)->setAttribute('align','center');
